...
document.getElementById("end-game-btn").addEventListener("click", function() {
    // Отримуємо значення high-score-lbl
    let highScore = document.getElementById("high-score-lbl").innerText;

    // Відправляємо повідомлення у бота Telegram
    let message = `High Score: ${highScore}`;
